...
tf.app.flags.DEFINE_boolean('hypertune', False,
...
tf.app.flags.DEFINE_string('results_file', './results.txt',
...
tf.app.flags.DEFINE_integer('checkpoint_interval', 50, """Number of episodes of interval between checkpoint saves""")
...
tf.app.flags.DEFINE_integer('max_nb_episodes_train', 100, """Max number of episodes of training time""")
tf.app.flags.DEFINE_float('gradient_clip_value', 50.0, """gradient_clip_value""")
tf.app.flags.DEFINE_integer('nb_test_episodes', 10, """Test episodes""")
tf.app.flags.DEFINE_integer('nb_hyperparam_runs', 5, """Hyperparameter tuning runs""")
