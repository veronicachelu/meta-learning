...
tf.app.flags.DEFINE_integer('summary_interval', 10000, """Number of episodes of interval between summary saves""")
tf.app.flags.DEFINE_integer('checkpoint_interval', 10000, """Number of episodes of interval between checkpoint saves""")
...
tf.app.flags.DEFINE_integer('max_nb_episodes_train', 10000000, """Max number of episodes of training time""")
