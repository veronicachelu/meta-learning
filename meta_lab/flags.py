...
tf.app.flags.DEFINE_string('model_name', "NoMetaGenAdvBeta_Conv_OneHotReward_V_0.25_BetaE_0.05_LargeGrid", """Name of the model""")
tf.app.flags.DEFINE_integer('height', 84, """Height of the screen""")
tf.app.flags.DEFINE_integer('width', 84, """Width of the screen""")
